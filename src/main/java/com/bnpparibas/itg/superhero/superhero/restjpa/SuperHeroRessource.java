...
public class SuperHeroRessource {
    ...
    public void initManyToMany (){
        Costume c1 = new Costume(true,true, Color.BLUE,true);
        ...
        SuperHero sh1 = new SuperHero("sh1","secreteSh1",c1,a1,e1);
        superHeroRepositoryRest.save(sh1);

        Set<Enemy> e2 = new HashSet<>(Arrays.asList(new Enemy("e2",null)));
        SuperHero sh2 = new SuperHero("sh2","secreteSh2",c1,a1,e2);
        ...
        SuperHero sh3 = new SuperHero("sh3","secreteSh3",c1,a3,e3);
